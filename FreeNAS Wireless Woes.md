Attempted a [Netgear N300](https://wikidevi.com/wiki/Netgear_WNA3100) with the **BCM43231** chipset, assuming that the **[bwi](http://www.freebsd.org/cgi/man.cgi?query=bwi&sektion=4)** driver could be loaded via a [tunable](http://doc.freenas.org/index.php/Tunables).
