...
I used this [to kick my stupid printer every hour](/Turning_Off_Deep_Sleep_on_Brother_HL2350DW/).

---

Because I don't trust things to continue to be on the internet. Here's [the source](https://ubntwiki.com/products/software/unifi-controller/api):

## Cached, Unofficial API Docs
