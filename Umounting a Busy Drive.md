...
You could try `lsof` to see what's using the drive. Use the device name (`/dev/sd*`) like so:
...
Aha! Now if you're confident that you can kill that job, go ahead and then try umounting the drive.
