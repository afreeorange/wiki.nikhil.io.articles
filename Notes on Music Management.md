I used [Beets](https://beets.readthedocs.io/en/stable/index.html) to reorganize my music and get out of the clutches of iTunes (or the 'Music' App). I have about ~22,000 tracks and spent a cumulative of a week importing them into Beets. It uses the lovely and amazing SQLite for its database making it possible to write all sorts of UIs on top of it ❤️
...
I don't use Music to sync songs to my phone and rely on [iMazing](https://imazing.com/iphone-music-transfer) instead. I don't use Music to edit Metadata and use the awesome [mp3Tag](https://www.mp3tag.de/en/) instead. If on Linux, `beet edit` with your favorite editor will work just fine (except for album art... not sure how you'd do that at the CLI).
