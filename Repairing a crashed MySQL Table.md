You may be chugging along, doing your thing, logging on to MySQL, and issuing something like this:
...
`user`, of course, is the table you wanted to recover. If the Gods have mercy, you will see something like this:
